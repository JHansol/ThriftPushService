...
import sol.xyz.linears.push_client.fragment.dialog.common.ViewHolder;
import sol.xyz.linears.push_client.fragment.dialog.common.models.IDialog;
import sol.xyz.linears.push_client.utils.DateFormatter;
        ...
        public void onBind(final DIALOG dialog) {
            ...
            if (blurredView != null) {
                if(dialog.isRead())
                    ...
                    blurredView.setBackgroundColor(Color.rgb(245,245,245)); //249
            }
