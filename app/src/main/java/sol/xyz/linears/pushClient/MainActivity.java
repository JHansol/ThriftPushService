...
import sol.xyz.linears.pushClient.pushService.Prefer;
import sol.xyz.linears.pushClient.pushService.PushManager;
import sol.xyz.linears.pushClient.utils.HanLog;
import sol.xyz.linears.pushClient.utils.UuidUtil;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void BadgeCountInit(){
        ...
        intent.putExtra("badge_count", 0); // 서버에서 갱신하도록 개선할 것
