...
import sol.xyz.linears.pushClient.MainActivity;
...
import sol.xyz.linears.pushClient.utils.JsonDialogHelper;

import static sol.xyz.linears.pushClient.utils.HanLog.han_Log;
...
public class PushNotification {
    ...
    private void AddPushList(MessageStruct data){
        ...
        Global.pushAlarmList.add(0,push);
